...
public class PlayerBowser extends Actor {
    Rectangle bounds;
    ...
    public void draw(Batch batch, float parentAlpha) {
        super.draw(batch, parentAlpha);
         ...
         if(time < 0.5f){
                batch.draw(manager.get("mario2.png", Texture.class), getX(), getY());
         } else {
                batch.draw(manager.get("mario3.png", Texture.class), getX(), getY());
         }
